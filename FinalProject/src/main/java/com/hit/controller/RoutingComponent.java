...
public class RoutingComponent extends HttpServlet {
	...
	/* *
	 * Responsible for routing requests to the appropriate controller class based on the MVC design pattern.
	 * The algorithm will make decisions by the URL path using split on the '/' delimiter.
	 * */
